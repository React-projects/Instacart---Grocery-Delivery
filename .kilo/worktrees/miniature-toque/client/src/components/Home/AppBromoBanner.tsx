...
const AppBromoBanner = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 xl:pl-10">
                <div className="text-center md:text-left">
                    <h2 className="text-3xl text-white mb-3 font-serif">{appPromoBannerData.title}</h2>
                ...
                <div className="mt-10 md:mt-0">
                    <img src={assets.delivery_truck} alt="App Promo Banner" className="max-w-60 sm:max-w-120 xl:pr-10" />
                </div>
            </div>
        </section>
    );
