...
const NewsLetter = () => {
    return (
        <section className="bg-white py-18 px-4 sm:px-6 Ig:px-8 rounded-3xl mx-auto shadow-xs mt-32 mb-20">
            <div className="max-w-2xl mx-auto text-center">
                ...
                <h2 className="text-app-text-light mb-5 text-base">Subscribe to our newsletter</h2>
                ...
                <form onSubmit={e => e.preventDefault()} className=" flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                    <input type="email" placeholder="Enter your email" className="flex-1  rounded-xl px-5 py-3.5 border border-app-green focus:border-app-green focus:ring bg-white text border-app text-sm transition-all" aira-label="Enter your email" />
