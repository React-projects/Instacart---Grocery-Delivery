                   ...
                   <div className='p-6 md:p-10 flex flex-col justify-center'>
                      ...
                      <div className='flex items-center gap-3'>
                         ...
                         <button
                            ...
                            className={`px-6 flex-1 py-3 font-semibold rounded-xl transition-colors flex-center gap-2 disabled:opacity-50 disabled: cursor-not-allowed active:scale-[0.98] ${inCart ? 'bg-app-cream text-app-green border border-app-green text-app-green' : 'bg-app-orange  text-white hover:bg-app-orange-dark'} `}>
